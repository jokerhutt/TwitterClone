...
function ProfileFeed ({posts, currentUser, setCurrentUser, setPosts}) {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:6789/api/users/${profileUserId}/`)
    ...
    useEffect(() => {
        fetch(`http://localhost:6789/api/users/posts/${profileUserId}/`)
        .then(response => response.json())
    ...
    return(
        <div className="flex flex-col flex-grow">
            ...
            <div className="flex-[45] flex h-full w-full px-4">
                ...
                <div>
                    <div className="flex gap-2 items-center">
                        <h2 className="text-xl font-bold">Jokerhut</h2> <MdOutlineVerified className="text-twitterBlue"/>
                    </div>
            ...
            <div className="flex-[240] h-full w-full relative">
                <div>
                    <img src="https://pbs.twimg.com/profile_banners/1732317437528293376/1733517871/1500x500"/>
                </div>
                <div className="z-45 absolute -translate-x-1 -bottom-1/4  mb-2 ml-4 max-h-35 max-w-35">
                    <img className="rounded-full h-32 w-auto object-cover border-4 border-black" src="https://pbs.twimg.com/profile_images/1865134959498780672/2ntWrRqt_400x400.jpg"/>
                </div>
            </div>
            <div className="flex-[200] flex-col h-full w-full flex px-4 py-3">
                ...
                <div className="flex-[47] h-full w-full mt-4">
                    <h2 className="font-bold text-2xl">Jokerhut</h2> 
                    <p className="text-sm">@TheJokerHut</p>
                </div>
